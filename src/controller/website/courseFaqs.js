  ...
  try {
    ...
    if (!inputData || Object.keys(inputData).length === 0) {
      return apiHTTPResponse(
        ...
        "No data provided to update course faq panel",
        CONSTANTS.DATA_NULL,
    ...
    logMessage("Error in updateCourseFaqPanel controller", error, "error");
    return apiHTTPResponse(
      req,
      res,
...
export const getCourseFaqPanel = async (req, res) => {
  try {
    ...
    logMessage("Error in getCourseFaqPanel controller", error, "error");
    return apiHTTPResponse(
      req,
      res,
      CONSTANTS.HTTP_INTERNAL_SERVER_ERROR,
